...
export const Loader = ({ speedMultiplier = 1, sizeMultiplier = 1 }: Props): ReactElement => (
	<StyledContainer speedMultiplier={speedMultiplier}>
		...
		>
			...
			/>
			<g className="book book-one" fillRule="evenodd">
				<path
					fill={theme.colors.books.primary}
					d="M31 29h4c1.105 0 2 .895 2 2v29c0 1.105-.895 2-2 2h-4c-1.105 0-2-.895-2-2V31c0-1.105.895-2 2-2z"
				/>
				<path
					fill={theme.colors.onBooks.primary}
