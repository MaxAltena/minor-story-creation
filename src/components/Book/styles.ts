...
export const StyledContainerOld = styled.div`
	...
	.book article *:not(.chapter-title):not(hr):not(dl) {
		margin: 0 auto;
		max-width: 28.125em;
	}
	...
	.book .chapter-title + p:first-of-type {
		text-indent: 0;
	}

	.book .chapter-title + p:first-of-type:first-letter {
		float: left;
